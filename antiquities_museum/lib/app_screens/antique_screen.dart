...
class AntiqueScreen extends StatefulWidget {
  ...
  const AntiqueScreen({super.key, required this.antiqueData});
...
class _AntiqueScreenState extends State<AntiqueScreen> {
  ...
  void initState() {
    ...
    _antiqueImages= data['images'] is List<dynamic> ? data['images'] : [''];
                          ...
                          child: ClipRRect(
                            ...
                            child:Image.network(
                              ...
                              errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                                return const Center(child:Icon(Icons.broken_image)); // Display an error icon or any other widget
                              },
            ...
            ElevatedButton(
              onPressed:(){
                Navigator.push(context, MaterialPageRoute(builder: (context) => ChatBotScreen(
                  isSerch: true,
                  text: "tell me more about Artifact piece: '$_antiqueName',\n in '${appData.lang}' language.",
                  image: _antiqueImages[0],
                )
                ),
                );
              },
