                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        Navigator.of(context).pop();
                        await Future.delayed(const Duration(milliseconds: 100));
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const ChatBotScreen(isSerch: false,)),);
                      },
                      child: Row(
                        children: [
                          const Expanded(
              ...
              Container(
                ...
                child: InkWell(
                  onTap: () async {
                    Navigator.of(context).pop();
                    await Future.delayed(const Duration(milliseconds: 100));
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const LanguagesScreen(isStart: false,)),);
                  },
                  child: Row(
                    children: [
                      const Expanded(
