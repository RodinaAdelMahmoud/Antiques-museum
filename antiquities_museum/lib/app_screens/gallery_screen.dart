                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CollectionScreen(collectionId: _collectionsList[index]['collection_id']!, title: collName,),
                            ),
                          );
                        },
                        child: Text(
                        ...
                        return SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              print("runtimeType:${data['images'].runtimeType}");

                              var antiqueimage = data['images'] is List<dynamic> ? data['images'][0] : '';
